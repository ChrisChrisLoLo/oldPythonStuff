...
def pause():
    paused = True
    message_to_screen("Paused",deepGreen,-100,largeFont)
    message_to_screen("Press C to continue or Q to quit",deepGreen,y_displace=25)
...
def score(score,font=smallFont):#,font = smallFont):
    text = font.render("Score: " + str(score),True,deepGreen)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Press C to play, P to pause, or Q to quit", black, 120)
        pygame.display.update()
...
def gameLoop():
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            message_to_screen("Your score was: " + str(scorenum), black, 50,smallFont)
            message_to_screen("Press C to play again or Q to quit",black, 90,smallFont)
            pygame.display.update()
